...
=======
			...
			<input type="checkbox" dependency='0' name="cmsc2xx[0]" value="CMSC201" id="201" onclick="selected('cmsc201');showMe('cmsc202');"><label for="201"></label>  CMSC201 
			<span class="textstyleDescription">: (4.00) Computer Science I for Majors </span>  <br></div>
			
			<div id='cmsc202' class='content1' style="color: grey;">
			<input type="checkbox" dependency='0' disabled name="cmsc202" value="CMSC202" id="202" onclick="selected('cmsc202');lockprev('cmsc201', 'cmsc202');showMe('cmsc203');showMe('cmsc304');showMe('cmsc486');"><label for="202"></label>  CMSC202  
			...
			<div id='cmsc291' class='content1' style="color: orange;">
			<input type="checkbox" dependency='0' name="cmsc2xx[4]" value="CMSC291" id="291" onclick="selected('cmsc291');"><label for="291"></label>  CMSC 291 <span class="textstyleDescription">: (1.00 - 4.00) Special Topics in Computer Science </span> <br>	</div>
...
>>>>>>> 887f675e7928747ddfb24e3771fa04bfb1554d77
...
=======
				...
				<div id='cmsc421' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' req='000' disabled name="cmsc4xx[1]" value="CMSC421" id="421" onclick="selected('cmsc421');lockprev('cmsc313', 'cmsc421');lockprev('cmsc341', 'cmsc421');tworeq('cmsc487', 'cmsc421');showMe('cmsc483');showMe('cmsc426');"><label for="421"></label> CMSC 421 <span class="textstyleDescription">: (3.00) Principles of Operating Systems </span> <br></div> 

				<div id='cmsc426' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[2]" value="CMSC426" id="426" onclick="selected('cmsc426');lockprev('cmsc421', 'cmsc426');"><label for="426"></label> CMSC 426 <span class="textstyleDescription">: (3.00) Principles of Computer Security </span> <br> </div> 
				
				<div id='cmsc427' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[3]" value="CMSC427" id="427" onclick="selected('cmsc427');lockprev('cmsc341', 'cmsc427');"><label for="427"></label> CMSC 427 <span class="textstyleDescription">: (3.00) Wearable Computing </span> <br></div> 
				
				<div id='cmsc431' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' req='000' disabled name="cmsc4xx[4]" value="CMSC431" id="431" onclick="selected('cmsc431');lockprev('cmsc331', 'cmsc431');lockprev('cmsc341', 'cmsc431');"><label for="431"></label>  CMSC 431 <span class="textstyleDescription">: (3.00) Compiler Design Principles </span> <br></div> 
				
				<div id='cmsc432' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[5]" value="CMSC432" id="432" onclick="selected('cmsc432');lockprev('cmsc331', 'cmsc432');"><label for="432"></label>  CMSC 432 <span class="textstyleDescription">: (3.00) Object-Oriented Programming Languages and Systems </span> <br></div> 
				
				<div id='cmsc433' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[6]" value="CMSC433" id="433" onclick="selected('cmsc433');lockprev('cmsc331', 'cmsc433');"><label for="433"></label> CMSC 433 <span class="textstyleDescription">: (3.00) Scripting Languages </span> <br> </div> 
				
				<div id='cmsc435' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' req='000' disabled name="cmsc4xx[7]" value="CMSC435" id="435" onclick="selected('cmsc435');lockprev('cmsc313', 'cmsc435');lockprev('cmsc341', 'cmsc435');tworeq('cmsc493', 'cmsc435');"><label for="435"></label>  CMSC 435 <span class="textstyleDescription">: (3.00) Computer Graphics </span> <br> </div> 
				
				<div id='cmsc436' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[8]" value="CMSC436" id="436" onclick="selected('cmsc436');lockprev('cmsc341', 'cmsc436');"><label for="436"></label>  CMSC 436 <span class="textstyleDescription">: (3.00) Data Visualization </span> <br> </div> 
				
				<div id='cmsc437' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[9]" value="CMSC437" id="437" onclick="selected('cmsc437');lockprev('cmsc341', 'cmsc437');"><label for="437"></label> CMSC 437 <span class="textstyleDescription">: (3.00) Graphical User Interface Programming </span> <br> </div> 
				
				<div id='cmsc441' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[10]" value="CMSC441" id="441" onclick="selected('cmsc441');lockprev('cmsc341', 'cmsc441');"><label for="441"></label> CMSC 441 <span class="textstyleDescription">: (3.00) Design and Analysis of Algorithms. </span> <br> </div> 
				
				<div id='cmsc442' class='content1' style="color: orange;">
				<input class="400-level-box" type="checkbox" dependency='0' name="cmsc4xx[11]" value="CMSC442" id="442" onclick="selected('cmsc442');"><label for="442"></label> CMSC 442 <span class="textstyleDescription">: (3.00) Information and Coding Theory </span> <br> </div>
				
				<div id='cmsc443' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[12]" value="CMSC443" id="443" onclick="selected('cmsc443');lockprev('cmsc341', 'cmsc443');"><label for="443"></label>  CMSC 443 <span class="textstyleDescription">: (3.00) Cryptology </span> <br> </div> 
				
				<div id='cmsc444' class='content1' style="color: orange;">
				<input class="400-level-box" type="checkbox" dependency='0' name="cmsc4xx[13]" value="CMSC444" id="444" onclick="selected('cmsc444');"><label for="444"></label>  CMSC 444 <span class="textstyleDescription">: (3.00) Information Assurance </span> <br></div> 
				
				<div id='cmsc446' class='content1' style="color: orange;">
				<input class="400-level-box" type="checkbox" dependency='0' name="cmsc4xx[14]" value="CMSC446" id="446" onclick="selected('cmsc446');"><label for="446"></label>  CMSC 446 <span class="textstyleDescription">: (3.00) Introduction to Design Patterns </span> <br></div> 
				
				<div id='cmsc447' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[15]" value="CMSC447" id="447" onclick="selected('cmsc447');lockprev('cmsc341', 'cmsc447');showMe('cmsc448');"><label for="447"></label>  CMSC 447 <span class="textstyleDescription">: (3.00) Software Design and Development </span> <br> </div> 
				
				<div id='cmsc448' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[16]" value="CMSC448" id="448" onclick="selected('cmsc448');lockprev('cmsc447', 'cmsc448');"><label for="448"></label>  CMSC 448 <span class="textstyleDescription">: (3.00) Software Engineering II </span> <br></div> 
				
				<div id='cmsc451' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[17]" value="CMSC451" id="451" onclick="selected('cmsc451');lockprev('cmsc203', 'cmsc451');"><label for="451"></label>  CMSC 451 <span class="textstyleDescription">: (3.00) Automata Theory and Formal Languages </span> <br></div> 

				<div id='cmsc452' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[18]" value="CMSC452" id="452" onclick="selected('cmsc452');lockprev('cmsc203', 'cmsc452');"><label for="452"></label>  CMSC 452 <span class="textstyleDescription">: (3.00) Logic for Computer Science </span> <br> </div> 
				
				<div id='cmsc453' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[19]" value="CMSC453" id="453" onclick="selected('cmsc453');lockprev('cmsc341', 'cmsc453');"><label for="453"></label>  CMSC 453 <span class="textstyleDescription">: (3.00) Applied Combinatorics and Graph Theory </span> <br> </div> 
				
				<div id='cmsc455' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[20]" value="CMSC455" id="455" onclick="selected('cmsc455');lockprev('cmsc341', 'cmsc455');"><label for="455"></label>  CMSC 455 <span class="textstyleDescription">: (3.00) Numerical Computations </span> <br> </div> 
				
				<div id='cmsc456' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[21]" value="CMSC456" id="456" onclick="selected('cmsc456');lockprev('cmsc341', 'cmsc456');"><label for="456"></label>  CMSC 456 <span class="textstyleDescription">: (3.00) Symbolic Computation </span> <br></div> 
				
				<div id='cmsc457' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[22]" value="CMSC457" id="457" onclick="selected('cmsc457');lockprev('cmsc203', 'cmsc457');"><label for="457"></label> CMSC 457 <span class="textstyleDescription">: (3.00) Quantum Computation </span> <br> </div> 
				
				<div id='cmsc461' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[23]" value="CMSC461" id="461" onclick="selected('cmsc461');lockprev('cmsc341', 'cmsc461');tworeq('cmsc465', 'cmsc461');tworeq('cmsc466', 'cmsc461');"><label for="461"></label>  CMSC 461 <span class="textstyleDescription">: (3.00) Database Management Systems </span> <br> </div> 
							
				<div id='cmsc465' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' req='000' disabled name="cmsc4xx[24]" value="CMSC465" id="465" onclick="selected('cmsc465');lockprev('cmsc481', 'cmsc465');lockprev('cmsc461', 'cmsc465');"><label for="465"></label>  CMSC 465 <span class="textstyleDescription">: (3.00) Introduction to Electronic Commerce </span> <br> </div> 
				
				<div id='cmsc466' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' req='000' disabled name="cmsc4xx[25]" value="CMSC466" id="466" onclick="selected('cmsc466');lockprev('cmsc481', 'cmsc466');lockprev('cmsc461', 'cmsc466');"><label for="466"></label>  CMSC 466 <span class="textstyleDescription">: (3.00) Electronic Commerce Technology </span> <br></div>
...
=======
				...
				<div id='cmsc475' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[28]" value="CMSC475" id="475" onclick="selected('cmsc475');lockprev('cmsc341', 'cmsc475');"><label for="475"></label>  CMSC 475 <span class="textstyleDescription">: (3.00) Introduction to Neural Networks </span> <br> </div> 
				
				<div id='cmsc476' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[29]" value="CMSC476" id="476" onclick="selected('cmsc476');lockprev('cmsc341', 'cmsc476');"><label for="476"></label>  CMSC 476 <span class="textstyleDescription">: (3.00) Information Retrieval </span> <br> </div> 
				
				<div id='cmsc477' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[30]" value="CMSC477" id="477" onclick="selected('cmsc477');lockprev('cmsc471', 'cmsc477');"><label for="477"></label>  CMSC 477 <span class="textstyleDescription">: (3.00) Agent Architectures and Multi-Agent Systems </span> <br> </div> 
				
				<div id='cmsc478' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[31]" value="CMSC478" id="478" onclick="selected('cmsc478');lockprev('cmsc471', 'cmsc478');"><label for="478"></label>  CMSC 478 <span class="textstyleDescription">: (3.00) Introduction to Machine Learning </span> <br></div> 
					
				<div id='cmsc479' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[32]" value="CMSC479" id="479" onclick="selected('cmsc479');lockprev('cmsc471', 'cmsc479');"><label for="479"></label> CMSC 479 <span class="textstyleDescription">: (3.00) Introduction to Robotics </span> <br> </div> 

				<div id='cmsc481' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[33]" value="CMSC481" id="481" onclick="selected('cmsc481');lockprev('cmsc341', 'cmsc481');tworeq('cmsc487', 'cmsc481');tworeq('cmsc466', 'cmsc481');tworeq('cmsc465', 'cmsc481');"><label for="481"></label> CMSC 481 <span class="textstyleDescription">: (3.00) Computer Networks </span> <br> </div> 
				<div id='cmsc483' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[34]" value="CMSC483" id="483" onclick="selected('cmsc483');lockprev('cmsc421', 'cmsc483');"><label for="483"></label>  CMSC 483 <span class="textstyleDescription">: (3.00) Parallel and Distributed Processing </span> <br> </div> 
			
				<div id='cmsc484' class='content1' style="color: orange;">
				<input class="400-level-box" type="checkbox" dependency='0' name="cmsc4xx[35]" value="CMSC484" id="484" onclick="selected('cmsc484');"><label for="484"></label> CMSC 484 <span class="textstyleDescription">: (3.00) Java Server Technologies </span> <br> </div> 

				<div id='cmsc486' class='content1' style="color: grey;">
					<input class="400-level-box" type="checkbox" dependency='0' disabled name="cmsc4xx[36]" value="CMSC486" id="486" onclick="selected('cmsc486');lockprev('cmsc202', 'cmsc486');"><label for="486"></label>  CMSC 486 <span class="textstyleDescription">: (3.00) Mobile Telephony Communications </span> <br> </div> 
				</div>
				
				<div id='cmsc487' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' req='000' disabled name="cmsc4xx[37]" value="CMSC487" id="487" onclick="selected('cmsc487');lockprev('cmsc421', 'cmsc487');lockprev('cmsc481', 'cmsc487');"><label for="487"></label>  CMSC 487 <span class="textstyleDescription">: (3.00) Introduction To Network Security </span> <br></div> 
			
				<div id='cmsc491' class='content1' style="color: orange;">
				<input class="400-level-box" type="checkbox" dependency='0' name="cmsc4xx[38]" value="CMSC491" id="491" onclick="selected('cmsc491');"><label for="491"></label>  CMSC 491 <span class="textstyleDescription">: (3.00) Special Topics in Computer Science </span> <br> </div> 
				<div id='cmsc493' class='content1' style="color: grey;">
				<input class="400-level-box" type="checkbox" dependency='0' req='000' disabled name="cmsc4xx[39]" value="CMSC493" id="493" onclick="selected('cmsc493');lockprev('cmsc471', 'cmsc491');lockprev('cmsc435', 'cmsc493');"><label for="493"></label>  CMSC 493 <span class="textstyleDescription">: (3.00) Capstone Games Group Project </span> <br></div> 
			
				<div id='cmsc495' class='content1' style="color: orange;">
				<input class="400-level-box" type="checkbox" dependency='0' name="cmsc4xx[40]" value="CMSC495" id="495" onclick="selected('cmsc495');"><label for="495"></label>  CMSC 495 <span class="textstyleDescription">: (3.00) Honors Thesis </span> <br></div> 
			
				<div id='cmsc498' class='content1' style="color: orange;">
				<input class="400-level-box" type="checkbox" dependency='0' name="cmsc4xx[41]" value="CMSC498" id="498" onclick="selected('cmsc498');"><label for="498"></label>  CMSC 498 <span class="textstyleDescription">: (3.00) Independent Study in Computer Science for CMSC Interns and Coop Students </span> <br> </div> 
